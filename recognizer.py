...
def identify1(frame, name):
        ...
        path = f"D:/MY_Projects/Experiment/attendance/detected/{name}_{timestamp}.png"
...
def identify_faces(video_capture):
    ...
    while True:
        ...
        if process_this_frame:
            predictions = predict(rgb_frame, model_path="D:/MY_Projects/Experiment/attendance/models/trained_model.clf")
            #print(predictions)
        ...
        for name, (top, right, bottom, left) in predictions:
            ...
            pat = name+'*'
            files = os.listdir('D:/MY_Projects/Experiment/attendance/dataset')
            for file in files:
